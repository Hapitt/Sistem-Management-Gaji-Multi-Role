<x-layouts.app :title="'Edit Jabatan - ' . $jabatan->jabatan">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Perbarui informasi jabatan {{ $jabatan->jabatan }} sesuai kebutuhan perusahaan.
                </p>
            </div>
        ...
        <div class="p-6">
            <form action="{{ route('admin.jabatan.update', $jabatan->id_jabatan) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="md:col-span-2">
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('jabatan') border-red-500 @enderror" 
                               id="jabatan" name="jabatan" value="{{ old('jabatan', $jabatan->jabatan) }}" placeholder="Masukkan nama jabatan" required>
                        @error('jabatan')
                    ...
                    <div class="md:col-span-2">
                        <div class="relative">
                            ...
                            <input type="number" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('gaji_pokok') border-red-500 @enderror" 
                                   id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok', $jabatan->gaji_pokok) }}" placeholder="0" min="0" required>
                        </div>
                        @error('gaji_pokok')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <div class="relative">
                            ...
                            <input type="number" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tunjangan') border-red-500 @enderror" 
                                   id="tunjangan" name="tunjangan" value="{{ old('tunjangan', $jabatan->tunjangan) }}" placeholder="0" min="0" required>
                        </div>
                        @error('tunjangan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="flex justify-end pt-6 border-t border-gray-200">
                    <a href="{{ route('admin.jabatan.index') }}" class="inline-flex items-center px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition-colors mr-4">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        Kembali
