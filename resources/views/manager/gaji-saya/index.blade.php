...
<div class="p-6 space-y-6 text-gray-900">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Lihat riwayat gaji Anda yang sudah diserahkan oleh admin.
                </p>
            </div>

            <!-- Search Form -->
            <form action="{{ route('manager.gaji-saya.index') }}" method="GET" class="flex flex-col sm:flex-row gap-2">
                <div class="flex">
                    <input type="month" 
                           name="periode" 
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div>
                <h3 class="font-medium text-blue-800">Informasi Gaji Manager</h3>
                <p class="text-sm text-blue-600 mt-1">
                    Anda hanya dapat melihat gaji Anda sendiri yang sudah diserahkan oleh admin. 
                    Jika ada periode yang belum muncul, silakan hubungi admin untuk proses penyerahan gaji.
                </p>
            </div>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-center gap-2">
                                    <!-- Detail Button -->
                                    <a href="{{ route('manager.gaji-saya.show', $row->id_gaji) }}" 
                        ...
                        <tr>
                            <td colspan="9" class="px-4 py-8 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    @if(request('search') || request('periode'))
                                        <a href="{{ route('manager.gaji-saya.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
