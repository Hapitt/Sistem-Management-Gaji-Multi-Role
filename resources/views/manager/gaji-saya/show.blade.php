    ...
    <div class="bg-white rounded-lg shadow border border-gray-200 p-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div class="flex justify-end">
                <a href="{{ route('manager.gaji-saya.index') }}" class="inline-flex items-center px-3 py-1.5 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium rounded transition-colors">
                ...
                <a href="{{ route('manager.gaji-saya.cetak', $gaji->id_gaji) }}"
