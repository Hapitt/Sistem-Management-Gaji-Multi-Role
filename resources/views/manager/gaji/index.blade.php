        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-semibold flex items-center gap-2">
                    ...
                    Gaji Divisi {{ $managerDivisi }}
                </h1>
                <p class="text-sm text-gray-500 mt-1">
                    Kelola ssemua gaji karyawan divisi {{ $managerDivisi }} secara cepat , tepat , ketat dan efisien.
                </p>
            </div>

            <div class="flex flex-col sm:flex-row gap-3">
                <!-- Search Form -->
                <form action="{{ route('manager.gaji.index') }}" method="GET" class="flex flex-col sm:flex-row gap-2">
                    <div class="flex">
                        <input type="text" 
                               name="search" 
                ...
                <!-- Add Button -->
                <a href="{{ route('manager.gaji.calculate') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors whitespace-nowrap">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-blue-700">
                <strong>Hak Akses Manager:</strong> Anda hanya dapat mengelola gaji karyawan di divisi <strong>{{ $managerDivisi }}</strong> 
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-center gap-1">
                                    ...
                                    <!-- Cetak PDF Button -->
                                    <a href="{{ route('manager.gaji.cetak', $row->id_gaji) }}" 
                    ...
                    @empty
                        <tr>
                            <td colspan="12" class="px-4 py-8 text-center text-gray-500">
                                ...
                                <div>Tidak ada data gaji untuk divisi {{ $managerDivisi }} pada periode atau pencarian tersebut.</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
