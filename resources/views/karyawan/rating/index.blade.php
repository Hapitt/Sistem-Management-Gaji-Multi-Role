...
<div class="p-6 space-y-6 text-gray-900">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <!-- Search Form -->
            <form action="{{ route('karyawan.rating.index') }}" method="GET" class="flex">
                <input type="text" 
                       name="search" 
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-sm text-blue-600 mt-1">
                    Anda hanya dapat melihat daftar rating yang tersedia. Informasi detail mengenai presentase bonus tidak tersedia untuk role karyawan.
                </p>
            </div>
        </div>
    </div>
